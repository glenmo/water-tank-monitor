...
void onEvent(ev_t ev) {
  ...
  switch(ev) {
    ...
    case EV_JOINED:
      ...
      loraJoined = true;
      loraSending = false;  // Reset flag so data sending can begin
      lastLoRaUploadTime = millis();  // Initialize to NOW to prevent immediate send
      lastWiFiUploadTime = millis();   // Initialize to NOW to prevent immediate send
