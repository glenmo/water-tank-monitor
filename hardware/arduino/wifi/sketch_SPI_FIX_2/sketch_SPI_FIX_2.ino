...
void setup() {
  ...
  // Let LMIC handle all radio init - do NOT touch SPI/NSS/RST manually
  // Manual SPI tests before os_init() leave the radio in an inconsistent
  // state and cause intermittent ASSERT failures in radio_sx127x.c
  os_init();
  LMIC_reset();
  
  // Verify radio is responding after LMIC init
